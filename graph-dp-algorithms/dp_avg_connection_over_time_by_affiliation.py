...
of connections between specific domains across distinct time spans.
"""
import pickle
import numpy as np
import pandas as pd
...
file_names = ['2000-2004--fas.harvard.edu-fas.harvard.edu', '2000-2004--fas.harvard.edu-college.harvard.edu', '2000-2004--fas.harvard.edu-gmail.com', '2000-2004--college.harvard.edu-college.harvard.edu', '2000-2004--college.harvard.edu-gmail.com', '2000-2004--gmail.com-gmail.com', '2004-2008--fas.harvard.edu-fas.harvard.edu', '2004-2008--fas.harvard.edu-college.harvard.edu', '2004-2008--fas.harvard.edu-gmail.com', '2004-2008--college.harvard.edu-college.harvard.edu', '2004-2008--college.harvard.edu-gmail.com', '2004-2008--gmail.com-gmail.com', '2008-2012--fas.harvard.edu-fas.harvard.edu', '2008-2012--fas.harvard.edu-college.harvard.edu', '2008-2012--fas.harvard.edu-gmail.com', '2008-2012--college.harvard.edu-college.harvard.edu', '2008-2012--college.harvard.edu-gmail.com', '2008-2012--gmail.com-gmail.com', '2012-2016--fas.harvard.edu-fas.harvard.edu', '2012-2016--fas.harvard.edu-college.harvard.edu', '2012-2016--fas.harvard.edu-gmail.com', '2012-2016--college.harvard.edu-college.harvard.edu', '2012-2016--college.harvard.edu-gmail.com', '2012-2016--gmail.com-gmail.com', '2016-2020--fas.harvard.edu-fas.harvard.edu', '2016-2020--fas.harvard.edu-college.harvard.edu', '2016-2020--fas.harvard.edu-gmail.com', '2016-2020--college.harvard.edu-college.harvard.edu', '2016-2020--college.harvard.edu-gmail.com', '2016-2020--gmail.com-gmail.com', '2020-2024--fas.harvard.edu-fas.harvard.edu', '2020-2024--fas.harvard.edu-college.harvard.edu', '2020-2024--fas.harvard.edu-gmail.com', '2020-2024--college.harvard.edu-college.harvard.edu', '2020-2024--college.harvard.edu-gmail.com', '2020-2024--gmail.com-gmail.com']
...
for i in range(len(fas_fas)):
    ...
    if G.number_of_nodes() == 0:
        fas_college_dp_edge_counts.append(0)
        fas_college_dp_node_counts.append(1)
    else:
    ...
    print("fas-gmail")
    if G.number_of_nodes() == 0:
        fas_gmail_dp_edge_counts.append(0)
        fas_gmail_dp_node_counts.append(1)
    else:
        flow_based_output = compute_avg_degree_connectivity(G, alpha)
    ...
    if G.number_of_nodes() == 0:
        college_college_dp_edge_counts.append(0)
        college_college_dp_node_counts.append(1)
    else:
        flow_based_output = compute_avg_degree_connectivity(G, alpha)
    ...
    print("college-gmail")
    if G.number_of_nodes() == 0:
        college_gmail_dp_edge_counts.append(0)
        college_gmail_dp_node_counts.append(1)
    else:
        flow_based_output = compute_avg_degree_connectivity(G, alpha)
    ...
    print("gmail-gmail")
    if G.number_of_nodes() == 0:
        gmail_gmail_dp_edge_counts.append(0)
        gmail_gmail_dp_node_counts.append(1)
    else:
        flow_based_output = compute_avg_degree_connectivity(G, alpha)
